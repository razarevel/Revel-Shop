...
export default function ContactSecForm() {
  const {
    register,
    handleSubmit,
    reset,
  ...
  return (
    <form
      className="space-y-6 lg:flex lg:items-center lg:space-y-0 lg:space-x-5"
    ...
    >
      <div>
        ...
        <input
          ...
          name="name"
          id="name"
          className="border border-black focus:outline-none placeholder:italic placeholder:text-black
             placeholder:text-sm placeholder:font-medium px-4 py-2 w-[80%] lg:w-full placeholder:opacity-70  font-medium opacity-70"
      ...
      <button
        disabled={!isValid}
        className={`bg-black w-12 h-12 lg:h-10 flex items-center justify-center ${
          isValid
      ...
      >
        ...
        >
          <path
            d="M60.049,10.871c0-0.002-0.001-0.005-0.001-0.007c-0.023-0.125-0.066-0.239-0.132-0.343
